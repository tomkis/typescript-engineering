...
- **[Slice Composition](architecture.md)** — The three horizontal layers within each vertical slice: validation (tRPC routers) → application (services) → domain (pure TS). Dependency rules, error handling.
