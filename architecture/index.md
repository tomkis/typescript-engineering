...
- **[Slice Composition](slice-composition.md)** — The four horizontal layers within each vertical slice: validation (tRPC routers) → application (services) → domain (pure TS) ← infrastructure (adapters). Dependency rules, error handling.
